...
var priorityType: [String] = ["Normal", "Important", "Very Important"]

class Assignment : NSObject, NSCoding {
    var desc: String = "", fromClass: String = "", note: String = "", dueDate: NSDate = NSDate(), opTime: Bool = false, repeatType: Int = 0, assignmentType: Int = 0, completed: Bool = false, priority: Int = 0
    var reminder: NSDate = NSDate()
    var nid: Int = 0 // Notification ID
    
    func setData (_desc: String, _fromClass: String, _note: String, _duedate: NSDate, _opTime: Bool, _repeatType: Int, _assignmentType: Int, _reminder: NSDate, _priority: Int, _nid: Int) {
        desc = _desc
    ...
    required init(coder aDecoder: NSCoder) {
        ...
        if let _priority = aDecoder.decodeIntegerForKey("priority") as? Int { self.priority = _priority }
    ...
    func encodeWithCoder(aCoder: NSCoder) {
        ...
        aCoder.encodeBool(opTime, forKey: "opTime")

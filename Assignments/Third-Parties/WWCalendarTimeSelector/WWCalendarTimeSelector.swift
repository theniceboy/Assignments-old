...
public class WWCalendarTimeSelector: UIViewController, UITableViewDelegate, UITableViewDataSource, WWCalendarRowProtocol, WWClockProtocol {
    ...
    public var optionCalendarBackgroundColorTodayHighlight = cblue // UIColor.brownColor()
    ...
    public var optionCalendarBackgroundColorPastDatesHighlight = cblue // UIColor.brownColor()
    ...
    public var optionCalendarBackgroundColorFutureDatesHighlight = cblue // UIColor.brownColor()
    ...
    public var optionClockBackgroundColorAMPMHighlight = cblue // UIColor.brownColor()
    ...
    public var optionClockBackgroundColorHourHighlight = cblue // UIColor.brownColor()
    public var optionClockBackgroundColorHourHighlightNeedle = cblue // UIColor.brownColor()
    ...
    public var optionClockBackgroundColorMinuteHighlight = cblue // UIColor.brownColor()
    public var optionClockBackgroundColorMinuteHighlightNeedle = cblue // UIColor.brownColor()
    ...
    public var optionButtonFontColorCancel = cblue // UIColor.brownColor()
    public var optionButtonFontColorDone = cblue // UIColor.brownColor()
    public var optionButtonFontColorCancelHighlight = cblue.colorWithAlphaComponent(0.25) // UIColor.brownColor().colorWithAlphaComponent(0.25)
    public var optionButtonFontColorDoneHighlight = cblue.colorWithAlphaComponent(0.25) // UIColor.brownColor().colorWithAlphaComponent(0.25)
    ...
    public var optionTopPanelBackgroundColor = cblue // UIColor.brownColor()
    ...
    public var optionSelectorPanelBackgroundColor = cblue.colorWithAlphaComponent(0.9) // UIColor.brownColor().colorWithAlphaComponent(0.9)
...
internal class WWCalendarRow: UIView {
    ...
    override func touchesEnded(touches: Set<UITouch>, withEvent event: UIEvent?) {
        ...
        if detail.type == .Date {
            ...
            let touch = touches.sort({ (s1, s2) -> Bool in
